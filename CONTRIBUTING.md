# Contributing to WildFly Security Incubator

Welcome to the WildFly Security Incubator organization! We welcome contributions from the community. This guide will walk you through the steps for getting started on our project.
...
First `cd` to the directory where you cloned the project (eg: `cd https://github.com/wildfly-security-incubator/{project_name}`)

Add a remote ref to upstream, for pulling future updates.
For example:

```
git remote add upstream https://github.com/wildfly-security-incubator/{project_name}
```
...
To build `https://github.com/wildfly-security-incubator/{project_name}` run:
```bash
mvn clean install
```
